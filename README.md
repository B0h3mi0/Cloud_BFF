...
Gemini ha dicho
Aquí tienes el código Markdown listo para que lo copies y lo pegues directamente en el editor de GitHub.

Le di un formato más profesional, usando bloques de código con resaltado de sintaxis, citas para notas importantes y tablas estructuradas para que los endpoints sean muy fáciles de leer visualmente.
